...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   System.out.println( "Row\tPrint Array" );
	   for ( int i = 0; i < intArray.length; i++ )
	      {
	        System.out.print( i + "\t" );
	        for ( int j = 0; j < intArray[i].length; j++ )
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   System.out.println("Row\tSetValue");
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println("Column\tFind Minimum");
	   ...
	   System.out.println(column + " = " + minValue);
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   System.out.println("\tCount Frequency " + value );
	   ...
	   System.out.println("Frequency of " + value + " = " + count);
